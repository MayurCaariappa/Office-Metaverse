      ...
      >
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          <div>
            <input
              ...
              className={`w-full px-4 py-3 rounded-lg border-2 outline-none transition duration-300 ${
                errors.username
        ...
        <div className="text-center">
          <div className="flex items-center justify-center my-4">
            ...
            <span className="px-4 text-gray-500 dark:text-gray-400 bg-white dark:bg-zinc-800">
              or
            </span>
            <div className="border-t border-gray-300 dark:border-zinc-700 w-full"></div>
          </div>
