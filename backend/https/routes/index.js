...
const { SignupSchema, SigninSchema, MapSchema } = require("../types/index.js");
const { z } = require("zod");
...
// const absolutePath = "D:\source\RandD\2d\Office-Metaverse\backend\uploads";
const uploadsPath = path.resolve(__dirname, '../uploads');
app.use('/uploads', express.static(uploadsPath));
// app.use("/uploads", express.static(path.join(__dirname, "https", "uploads")));
